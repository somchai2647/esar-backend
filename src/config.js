...
const config = {
  ...
  development: {
    mongo: {
      uri: 'mongodb+srv://esar:JAIHRoJ8zoXgOHlh@esar.2wjdn.mongodb.net/esar-dev?authSource=admin&replicaSet=atlas-xjqyer-shard-0&w=majority&readPreference=primary&appname=MongoDB%20Compass&retryWrites=true&ssl=true',
      options: {
        debug: true
      }
    }
